...
/**
 * Catalog factory impl for {@link HoodieHiveCatalog}.
 */
public class HoodieHiveCatalogFactory implements CatalogFactory {
  private static final Logger LOG = LoggerFactory.getLogger(HoodieHiveCatalogFactory.class);

  @Override
  public String factoryIdentifier() {
    return HoodieCatalogFactoryOptions.IDENTIFIER;
  }
